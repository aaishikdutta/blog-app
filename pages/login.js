...
import {  FormContainer,FormTitle, GoToForm, FormInputs } from "../components/AuthForms/FormHelpers";
import { loginInputs } from "../components/AuthForms/InputFields";
...
const Login = () => {
  ...
  return (
    ...
    >
      <GoToForm goToFormText="Don't have an account? " goToFormUrl="/register" goToFormLinkText="Register" />
