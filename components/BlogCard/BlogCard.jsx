...
const BlogCard = ({
  ...
  return (
    <div className="relative cursor-pointer flex flex-col rounded-[8px] bg-cyan-900 min-h-[420px] transition-all duration-500 ease-in-out hover:rotate-[-1deg] hover:scale-[1.01] hover:shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06)]">
      ...
      />
      <div className="flex flex-col h-full z-3 py-[32px] px-[16px] text-white">
        <h4 className="pb-[8px] text-[20px] font-light">{blogTitle}</h4>
        <h6 className="font-normal text-[12px] pb-[16px]">
          Posted on: {new Date(blogDate).toDateString()}
        </h6>
        <Link href="/">
